...
class CrapsDealer:
    ...
    def __init__(self, craps_table: CrapsTable):
    ...
    def bet_pass_odds(self, player: Player, bet_value: int):
...
class CrapsStickman:
    def __init__(self, dealer: CrapsDealer, table: CrapsTable):
        self.dealer = dealer
        self.table = table
    ...
    def snake_eyes(self, roll: tuple):


class CrapsPayouts:
    def pass_payout(self, bet_value: int):
        return bet_value

    def dont_pass_payout(self, bet_value: int):
        return bet_value

    def field_payout(self, bet_value: int, double_indicator: bool):
        if double_indicator:
            return bet_value * 2
        return bet_value

    def odds_payout(self, bet_value: int):
        if self.table.point_on in [4, 10]:
            return bet_value *